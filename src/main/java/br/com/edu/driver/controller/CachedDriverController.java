...
import br.com.edu.driver.service.CachedDriverService;

@RestController
public class CachedDriverController {
	
	private CachedDriverService driverService;
	
	private Logger logger = LogManager.getLogger(CachedDriverController.class);
	
	@RequestMapping(value="/cached/drivers", method = RequestMethod.POST )
	...
	@RequestMapping(value="/cached/drivers/status", method = RequestMethod.POST )
	...
	@RequestMapping(value="/cached/drivers/{id}/status", method = RequestMethod.GET )
	...
	@RequestMapping(value="/cached/drivers/inArea", method = RequestMethod.GET )
	...
	@Autowired
	public void setDriverService(CachedDriverService driverService) {
